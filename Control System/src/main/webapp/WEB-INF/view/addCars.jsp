...
<sec:authorize access="hasRole('ROLE_ADMIN')">
		...
		<form:form action="AddCar" method="POST" commandName="permanentVisitor">
			<table width="500px" bgcolor="#c0c0c0">
				<tr>
					<td style="padding-left:60px;align:center"><p>Дата</p></td>
					<td style="padding-left:60px;align:center"><input type="text" name="date" id="datepicker" value="${today}" style="width:200px;height:22px" /></td>
				</tr>
				<tr>
				...
				<tr>
					<td style="padding-left:60px;align:center"><p>Цвет авто</p></td>
					<td style="padding-left:60px;align:center"><input type="text" name="color" style="width:200px;height:22px" /></td>
				</tr>
				<tr>
