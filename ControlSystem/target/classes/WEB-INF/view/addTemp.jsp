	...
	<sec:authorize access="hasRole('ROLE_ADMIN')">
		...
		<form:form action="AddTemp" method="POST" commandName="permanentVisitor">
			<div  style="bgcolor:#c0c0c0;background:#c0c0c0;width:500px;">
						<button class="parallelogramm" name="action" value="Разовый пропуск" style="border: 2px solid red;width:200px;height:40px;background:#60a0d9;margin-left:70px;">Разовый<br/>пропуск</button>
						<button class="parallelogramm" name="action" value="Временный пропуск" style="width:200px;height:40px;background:#60a0d9"">Временный<br/>пропуск</button>
			</div>
		...
		<form:form action="AddTemp" method="POST" commandName="permanentVisitor">
			<table width="500px" bgcolor="#c0c0c0">
				...
				<tr>
					<td style="padding-left:60px;align:center"><p>Номер авто</p></td>
					<td style="padding-left:60px;align:center">
						<input type="text" id="number" name="carNumber" maxlength="1" style="width:15px;height:22px" onkeyup="testJump(this);" onkeypress="return app.restrictChars(this, event, rusOnly)" />
						<input maxlength="3" type="text" id="number2" name="carNumber" style="width:45px;height:22px;margin-left:5px;" onkeyup="testJump(this);" onkeypress="return app.restrictChars(this, event, digitsOnly)" />
						<input maxlength="2" type="text" id="number3" name="carNumber" style="width:30px;height:22px;margin-left:5px;" onkeyup="testJump(this);" onkeypress="return app.restrictChars(this, event, rusOnly)" />
						<input maxlength="3" type="text" id="number4" name="carNumber" style="width:45px;height:22px;margin-left:5px;" onkeypress="return app.restrictChars(this, event, digitsOnly)" />
					</td>
				</tr>
				<tr>
					<td style="padding-left:60px;align:center"><p>Марка авто</p></td>
